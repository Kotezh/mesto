...
Данная работа необходима для закрепления знаний первого спринта курса "JavaScript — непростые концепции". 
Сайт представляет из себя одностраничный лендинг с адаптацией контента под различные разрешения экранов. 
В текущем проекте реализован рефакторинг кода согласно концепциям ООП (созданы классы, код разбит на модули).
